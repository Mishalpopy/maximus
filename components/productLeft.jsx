          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-base  text-gray-700 hover:text-gray-900">
                    Sort
                    <ChevronDownIcon
        ...
        <Disclosure.Panel className="pt-6">
          <div className="space-y-4">
            {section.options.map((option, optionIdx) => (
              ...
              <div className="bg-white">
      <div className="mx-auto justify-center flex max-w-8xl overflow-hidden sm:px-6 lg:px-8">
        <h2 className="sr-only">Products</h2>

        <div className="grid grid-cols-1 border-l border-gray-200 sm:mx-0 md:grid-cols-3 lg:grid-cols-3">
