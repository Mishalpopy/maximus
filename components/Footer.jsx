  ...
  return (
    <footer className="relative w-full bg-black text-white py-6rem lg:px-20 md:px-20">
      <div className="mx-auto w-full max-w-7xl bg-black text-white">
        <div className="flex grid grid-cols-9 pt-[70px] pb-[27px] gap-0 w-full flex-col items-center border-b border-white-900 py-4 md:flex-row">
          {/* Your logo */}
          ...
          <div className="flex justify-between col-start-3 col-end-12 w-full">
